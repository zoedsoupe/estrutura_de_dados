...
introConjunto = do
  ...
  putStrLn $ toInfo
    "Este TAD recebe como entrada uma lista de inteiros\nExemplo: [1,2,3]\n"
...
runConjunto = do
  ...
  putStrLn . toSuccess $ "\nNovo conjunto -> " ++ toBold
    (ConjuntoInt.show conjunto')
  ...
  putStrLn . toSuccess $ "Segundo conjunto -> " ++ toBold
    (ConjuntoInt.show conjunto2)
